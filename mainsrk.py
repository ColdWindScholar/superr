...
def superr(mfunc=None):
    ...
    def assert_devices(assertch=None):
        ...
        while not choice:
            ...
            if not assertch:
                ...
                j.kprint(j.lang['startup_version'] + color['g'] + j.androidversion + '\n', 'b')
                j.kprint(j.lang['menu_asserts'] + '\n', 'ryb')
                j.kprint('1) ' + j.lang['menu_add_assert'] + ' (' + color['b'] + j.lang['title_current'] + color[
                    'g'] + assertdevices + color['n'] + ')')
                j.kprint('2) ' + j.lang['menu_asserts_custom'] + ' (' + color['b'] + j.lang['title_current'] + color[
                    'g'] + acuststat + color['n'] + ')')
                j.kprint('3) ' + j.lang['menu_asserts_remove'])
                j.kprint('4) ' + j.lang['menu_asserts_reset'])
            ...
            if choice == '1':  # START Add/Remove Device asserts
                ...
                j.banner()
                j.kprint(j.lang['asserts_current'] + color['g'] + assertdevices + '\n', 'b')
                j.kprint(j.lang['warning'] + '\n', 'yrbbo')
                j.kprint(j.lang['asserts_enter'])
                j.kprint(j.lang['asserts_enter2'])
                j.kprint(j.lang['asserts_enter3'] + '\n')
                j.kprint(j.lang['asserts_enter4'])
                j.kprint(j.lang['asserts_enter5'])
                j.kprint(j.lang['asserts_enter6'] + '\n')
                j.kprint(j.lang['example'] + '\n', 'gb')
                j.kprint('surnia,surnia_cdma,xt1526\n', 'y')
                a = input(devicename)

                if a:
                    a = a.replace(' ', '').replace(',', '', 1).strip().split(',')
                else:
                    a = []
                ...
                j.appendf(j.readf(j.tools + '/updater/custom/assert'), assertdir + '/assert')
                j.sedf('#DEVICENAME', devicename, assertdir + '/assert')

                for x in a:
                    if not j.greps('.*\\"' + x + '\\"', assertdir + '/assert'):
                        j.appendf('    ' + j.readf(j.tools + '/updater/custom/device'), assertdir + '/assert')
                        j.sedf('#DEVICENAME', x, assertdir + '/assert')
                        j.sedf('#DEVICECHK', devicechk, assertdir + '/assert')

                j.appendf('    ' + j.readf(j.tools + '/updater/custom/abort2'), assertdir + '/assert')
                j.sedf('#DEVICECHK', devicechk, assertdir + '/assert')
                ...
                while not assertcustom:
                    ...
                    try:
                        ...
                        j.banner()
                        j.kprint(j.lang['error'], 'yrbbo')
                        j.kprint(j.lang['asserts_cust_error'] + '"assert.name=assert.value"\n', 'r')
                ...
                j.appendf(j.readf(j.tools + '/updater/custom/assertcustom'), assertdir + '/assertcustom')
                ...
                j.delpath(assertdir + '/assert', assertdir + '/assertcustom')
                j.appendf(j.readf(j.tools + '/updater/custom/assert'), assertdir + '/assert')
                j.appendf('    ' + j.readf(j.tools + '/updater/custom/abort'), assertdir + '/assert')
                j.sedf('#DEVICENAME', devicename, assertdir + '/assert')
                j.sedf('#DEVICECHK', devicechk, assertdir + '/assert')
                j.awkadd('#ASSERT', j.readf(assertdir + '/assert'), 'after', 'first', j.usdir + '/updater-script')
                j.getconf('assert-no', j.mconf, 'rem')
                choice = ''
                continue

            if j.existf(assertdir + '/assertcustom'):
                j.grepff('.*ro.product.device', assertdir + '/assert', assertdir + '/assert-2')
                os.replace(assertdir + '/assert-2', assertdir + '/assert')
                j.appendf(j.readf(assertdir + '/assertcustom'), assertdir + '/assert')
            ...
            if (j.existd(j.rd + '/' + chosenimg + 'img')
                ...
                while not choice:
                    ...
                    if chosenimg == 'boot':
                        bmenu = '5'
                        with j.cd(j.bd):
                            j.appendf(j.cmd(j.rampy(chosenimg) + 'status ' + j.romname + ' boot'), j.logs + '/boot.log')
                    ...
                    if (not j.existf(j.rd + '/system/init.rc')
                            and not j.existf(j.rd + '/system/init.environ.rc')):
                        j.kprint('1) ' + j.lang['menu_pack_boot'] + chosenimg2 + ' ')
                    else:
                        j.kprint('1) ' + j.lang['menu_pack_boot'] + chosenimg2 + ' ', 'r')

                    if chosenimg == 'boot':
                        j.kprint('2) ' + j.lang['menu_insecure'] + chosenimg2 + ' (' + color['b'] + j.lang[
                            'title_current'] + insecstatus + color['n'] + ')')
                        j.kprint('3) ' + j.lang['menu_dmverity'] + ' (' + color['b'] + j.lang[
                            'title_current'] + veritystatus + color['n'] + ')')
                        j.kprint(
                            '4) ' + j.lang['menu_forcee'] + ' (' + color['b'] + j.lang['title_current'] + forceestatus +
                            color['n'] + ')')
                        j.kprint('5) ' + j.lang['menu_deopatch'])
                    ...
                    if choice == '1' and j.sar():
                        ...
                        with j.cd(j.bd):
                            blog = j.cmd(j.rampy(chosenimg) + 'insecure ' + j.romname + ' boot')
                    elif choice == '3':
                        with j.cd(j.bd):
                            blog = j.cmd(j.rampy(chosenimg) + 'dmverity ' + j.romname + ' boot')
                    elif choice == '4':
                        with j.cd(j.bd):
                            blog = j.cmd(j.rampy(chosenimg) + 'forcee ' + j.romname + ' boot')
                    elif choice == '5':
                        with j.cd(j.bd):
                            blog = j.cmd(j.rampy(chosenimg) + 'deopatch ' + j.romname + ' boot')
                    ...
                    if blog:
                        ...
                        if j.platf == 'win':
                            if j.greps('.*PermissionError', blog.splitlines()):
                                j.banner()
                                j.kprint(j.lang['error'], 'yrbbo')
                                j.kprint(j.lang['boot_permission_error'] + '\n', 'r')
                                j.kprint(j.lang['boot_permission_error2'], 'r')
                                j.kprint(
                                    'https://forum.xda-developers.com/t/windows-linux-mac-donate-superrs-kitchen-v3-2-0-9-6-28-2020.3601702/page-88#post-76870951\n',
                                    'y')
                                input(j.lang['enter_continue'])
                ...
                while not choice:
                    ...
                    j.kprint('1) ' + j.lang['menu_unpack'] + chosenimg2)
                    j.kprint('2) ' + j.lang['menu_boot_flashable'] + chosenimg)
                    if defboot:
                        j.kprint('3) ' + j.lang['menu_boot_restore'] + chosenimg2)
                    else:
                        j.kprint('3) ' + j.lang['menu_boot_restore'] + chosenimg2, 'r')
                    if snum > '3':
                        j.kprint('4) ' + j.lang['menu_switch_boot'])
                    j.kprint('m = ' + j.lang['title_main'], 'y')
                    j.kprint('q = ' + j.lang['menu_quit'] + '\n', 'm')
                    j.kprint(j.lang['select'])
                    choice = j.getChar()
                    ...
                    if choice == 'q':
                        ...
                        j.cp(j.tools + '/updater/binary/update-binary-meta', j.usdir + '/update-binary')
                        j.cp(j.tools + '/updater/binary/busybox-arm', j.rd + '/install/bin/busybox')
                        j.delpath(j.usdir + '/updater-script')
                        sigtitle = ''
                        if chosenimg == 'recovery':
                            sigzip = signature + '-recovery'
                            sigtitle = signature.replace('_', ' ') + ' Recovery'
                            j.cp(j.tools + '/updater/custom/updater-script-recovery', j.usdir + '/updater-script')
                        elif chosenimg == 'boot':
                            sigzip = signature + '-kernel'
                            sigtitle = signature.replace('_', ' ') + ' Kernel'
                            j.cp(j.tools + '/updater/custom/updater-script-kernel', j.usdir + '/updater-script')

                        if not j.existf(j.prfiles + '/assert'):
                            j.appendf(j.readf(j.tools + '/updater/custom/assert'), j.prfiles + '/boot/assert')
                            j.appendf('    ' + j.readf(j.tools + '/updater/custom/abort'), j.prfiles + '/boot/assert')
                            j.sedf('#DEVICENAME', devicename, j.prfiles + '/boot/assert')
                            j.sedf('#DEVICECHK', devicechk, j.prfiles + '/boot/assert')
                            j.awkadd('#ASSERT', j.readf(j.prfiles + '/boot/assert'), 'after', 'first',
                                     j.usdir + '/updater-script')
                        else:
                            j.awkadd('#ASSERT', j.readf(j.prfiles + '/assert'), 'after', 'first',
                                     j.usdir + '/updater-script')

                        j.grepvf('#ASSERT', j.usdir + '/updater-script')
                        j.sedf('#SIGNATURE', sigtitle, j.usdir + '/updater-script')
                        j.sedf('#SIGCUST', sigcust, j.usdir + '/updater-script')

                        if j.existf(j.rd + '/' + sigzip + '.zip'):
                            os.replace(j.rd + '/' + sigzip + '.zip', j.rd + '/' + sigzip + timestamp + '.zip')
                        ...
                        if j.getconf('ubinary', j.mconf) != 'no':
                            if j.getconf('ubinary', j.mconf) == 'yes':
                                ...
                                j.banner()
                                j.kprint(j.lang['cust_convert_binary_q'])
                                j.kprint(j.lang['cust_convert_binary_q2'])
                                reply = j.getChar()
                                if reply == 'y':
                                    j.ubinary(j.usdir)
                        ...
                        j.banner()
                        if chosenimg == 'recovery':
                            j.kprint(sigzip + '.zip ' + j.lang['general_build'] + j.romname + ' ...', 'b')

                            romlist = ['recovery.img', 'META-INF', 'install']
                            with j.cd(j.rd):
                                j.appendf(j.zipp(sigzip + '.zip', romlist), j.logs + '/zip.log')
                        elif chosenimg == 'boot':
                            j.kprint(sigzip + '.zip ' + j.lang['general_build'] + j.romname + ' ...', 'b')
                            romlist = ['boot.img', 'META-INF', 'install', 'kernel.img', 'ramdisk.img']
                            with j.cd(j.rd):
                                j.appendf(j.zipp(sigzip + '.zip', romlist), j.logs + '/zip.log')
                        else:
                            if rminstall:
                        ...
                        j.banner()
                        j.kprint(sigzip + '.zip ' + j.lang['general_create'] + j.romname + '\n', 'g')
                        signzip(sigzip)
                        break
                        ...
                        with j.cd(j.rd):
                            if j.platf == 'win':
                                with j.cd(j.bd):
                                    j.appendf(j.cmd(j.rampy(chosenimg) + 'delram ' + j.romname + ' ' + chosenimg),
                                              j.logs + '/boot.log')

                                j.delpath(chosenimg2)
                            else:
                                j.delpath(chosenimg + 'img', chosenimg2)

                            j.cp(j.prfiles + '/' + chosenimg2 + '_orig/' + chosenimg2, chosenimg2)
    ...
    def build_custom_zip():
        ...
        def docustzip(signature2):
            if j.existf(j.rd + '/' + signature2 + '.zip'):
                os.replace(j.rd + '/' + signature2 + '.zip', j.rd + '/' + signature2 + '_' + timestamp + '.zip')
            ...
            j.banner()
            j.kprint(signature2 + '.zip ' + j.lang['general_build'] + j.romname + ' ...', 'b')
            romlist = ['system', 'META-INF', 'install']
            with j.cd(j.rd):
                j.appendf(j.zipp(signature2 + '.zip', romlist), j.logs + '/zip.log')
            j.delpath(j.rd + '/META-INF')
            if j.existd(j.rd + '/META-INF1'):
                os.replace(j.rd + '/META-INF1', j.rd + '/META-INF')
        ...
        while not choice:
            ...
            j.kprint('1) ' + menu_cust['1'])
            j.kprint('2) ' + menu_cust['2'])
            j.kprint('3) ' + menu_cust['3'])
            j.kprint('4) ' + menu_cust['4'])
            j.kprint('5) ' + menu_cust['5'])
            j.kprint('6) ' + menu_cust['6'])
            ...
            j.banner()
            j.kprint(j.lang['cust_deldir_q'])
            j.kprint(j.lang['cust_deldir_q2'])
            reply = j.getChar()
            if reply != 'y':
                deldir = 'no'
            else:
            ...
            j.delpath(j.usdir + '/updater-script')
            j.cp(j.tools + '/updater/custom/updater-script-system', j.usdir + '/updater-script')
            part_setup('boot')
            if not j.existf(j.prfiles + '/assert'):
                j.appendf(j.readf(j.tools + '/updater/custom/assert'), j.prfiles + '/assert')
                j.appendf(j.readf(j.tools + '/updater/custom/abort'), j.prfiles + '/assert')
            ...
            if deldir == 'no':
                j.grepvf('delete_recursive|Deleting', j.usdir + '/updater-script')

            j.grepvf('#ASSERT', j.usdir + '/updater-script')
            j.sedf('#SIGNATURE', signature.replace('_', ' '), j.usdir + '/updater-script')
            j.sedf('#SIGCUST', sigcust, j.usdir + '/updater-script')
            j.sedf('#DEVICENAME', devicename, j.usdir + '/updater-script')
            j.sedf('#DEVICECHK', devicechk, j.usdir + '/updater-script')

            if j.sar():
                j.sedf('/system/', '/system/system/', j.usdir + '/updater-script')

            if choice in ['1', '2', '4']:
                appsym = sorted(
                    j.findf(j.sysdir + '/app/*') + j.findf(j.sysdir + '/priv-app/*') + j.findf(j.rd + '/vendor/app/*'))
                symlib = ['ui_print("Creating symlinks...");', 'ui_print(" ");']
                for i in j.grepf('/system/app|/system/priv-app', j.prfiles + '/symlinks-system'):
                    line = i.split('"')[3].split('/lib')[0].replace('/', '', 1)
                    if line in appsym:
                        symlib.append(i)
                symlib = '\n'.join(symlib)
                j.awkadd('#SYM', symlib, 'after', 'first', j.usdir + '/updater-script')
            ...
            if choice == '1':  # START framework, app, priv-app
                ...
                j.grepvf('.*/system/lib"|.*/system/lib64"|.*/system/media"', j.usdir + '/updater-script')
                ...
                if j.existd(j.sysdir + '/lib64'):
                    ...
                    j.grepvf('.*/system/lib64"|.*/system/media"', j.usdir + '/updater-script')
            elif choice == '3':  # START framework
                signature2 = signature + '-framework'

                j.grepvf('.*/system/priv-app"|.*/system/app"|.*/system/lib"|.*/system/lib64"|.*/system/media"',
                         j.usdir + '/updater-script')
            elif choice == '4':  # START app, priv-app
                signature2 = signature + '-ap'

                j.grepvf('.*/system/framework"|.*/system/lib"|.*/system/lib64"|.*/system/media"',
                         j.usdir + '/updater-script')
            elif choice == '5':  # START lib
                signature2 = signature + '-lib'

                if j.existd(j.sysdir + '/lib64'):
                    j.grepvf('.*/system/framework"|.*/system/priv-app"|.*/system/app"|.*/system/media"',
                             j.usdir + '/updater-script')
                else:
                    j.grepvf('.*/system/priv-app"|.*/system/app"|.*/system/lib64"|.*/system/media"',
                             j.usdir + '/updater-script')
            elif choice == '6':  # START media
                signature2 = signature + '-media'

                j.grepvf('.*/system/framework"|.*/system/priv-app"|.*/system/app"|.*/system/lib"|.*/system/lib64"',
                         j.usdir + '/updater-script')
            ...
            j.banner()
            if j.existf(j.rd + '/' + signature2 + '.zip'):
                j.kprint(signature2 + '.zip ' + j.lang['general_create'] + j.romname + '\n', 'g')
                signzip(signature2)
                input(j.lang['enter_build_menu'])
            else:
                j.kprint(j.lang['error'], 'yrbbo')
    ...
    def build_rom_zip():
        ...
        if j.existf(j.rd + '/' + signature + '.zip'):
            os.replace(j.rd + '/' + signature + '.zip', j.rd + '/' + signature + '_' + timestamp + '.zip')

        if j.existf(j.rd + '/' + signature + '-signed.zip'):
            os.replace(j.rd + '/' + signature + '-signed.zip', j.rd + '/' + signature + '-signed_' + timestamp + '.zip')
        ...
        if permtype == 'sparse_dat':
            ...
            useold = None
            if j.platf in ['win', 'mac'] or j.getconf('use_make_ext4fs', j.mconf) == 'Yes':
                useold = 1
            ...
            j.banner()
            j.kprint(signature + '.zip ' + j.lang['general_build'] + j.romname + ' ...\n', 'b')
            ...
            with j.cd(j.rd):
                ...
                j.appendf(j.zipp(signature + '.zip', exfiles, comp), j.logs + '/zip.log')
                j.delpath(*extmp)
            ...
            j.kprint(signature + '.zip ' + j.lang['general_build'] + j.romname + ' ...\n', 'b')
            j.kprint(j.lang['build_patient'] + '\n', 'y')
            exzipfiles = ['boot.img', 'META-INF', 'install', 'supersu', 'rootzip', 'busybox', 'gapps', 'xposed',
                          'magisk', 'data', 'kernel.img', 'ramdisk.img']
            if not j.getconf('data-set_metadata', j.uconf):
                exzipfiles.remove('data')
            ...
            j.banner()
            j.kprint(signature + '.zip ' + j.lang['general_build'] + j.romname + ' ...', 'b')

            exzipfiles = ['boot.img', 'META-INF', 'system', 'install', 'supersu', 'rootzip', 'busybox', 'gapps',
                          'xposed', 'magisk', 'data', '_exfiles', 'kernel.img', 'ramdisk.img']
            if not j.getconf('data-set_metadata', j.uconf):
                exzipfiles.remove('data')
            ...
            with j.cd(j.rd):
                if j.platf == 'win':
                    ...
                    for i in j.findr('**/*.ex*.srk'):
                        old_exl.append(i)
                        newpath = i.split('/')[0] + '_exfiles/' + '/'.join(i.split('/')[1:])[:-8]
        ...
        j.banner()
        if j.existf(j.rd + '/' + signature + '.zip'):
            j.kprint(signature + '.zip ' + j.lang['general_create'] + j.romname + '\n', 'g')
            signzip(signature)
            input(j.lang['enter_rom_tools'])
        else:
            j.kprint(j.lang['error'], 'yrbbo')
    ...
    def build_zip():
        ...
        while not choice:
            ...
            j.kprint('1) ' + j.lang['menu_build_zip'])
            j.kprint('2) ' + j.lang['menu_sys_img'] + ' (' + color['b'] + 'fs_config: ' + fsconf + ')')
            j.kprint('3) ' + j.lang['menu_sign'])
            j.kprint('4) ' + j.lang['donate_menu_custom_id'] + ' (' + color['b'] + j.lang['title_current'] + color[
                'g'] + bdisplay + color['n'] + ')')
            j.kprint('5) ' + j.lang['menu_custom_zip'], 'y')
            ...
            if choice == 'q':  # START Quit
                ...
                with j.cd(j.prfiles):
                    for i in j.findf('fs_config-*'):
                        i = i.split('-')[1]
                        if j.existd(j.rd + '/' + i):
                            if i not in imglist: imglist.append(i)

                for i in imglist:
                    if not j.existd(j.rd + '/' + i):
                        imglist.remove(i)

                chosenimg = j.chlist(color['gb'] + j.lang['build_img_which'] + color['n'], sorted(imglist),
                                     len(imglist))
                if not chosenimg:
                    main = 1
                    choice = ''
                ...
                while not choice2:
                    ...
                    print('1) raw')
                    print('2) sparse')
                    print('3) ' + ('new.dat.br' if j.getconf('brotli_comp', j.mconf) else 'new.dat'))
                    ...
                    if not j.existf(j.rd + '/' + chosenimg + '_new.img'):
                        ...
                        j.partsdat(chosenimg)
                        imgname = chosenimg + ('.new.dat.br' if j.getconf('brotli_comp', j.mconf) else '.new.dat')
                    else:
                        if j.existf(j.rd + '/' + chosenimg + '_new.img') and not j.existf(
                                j.rd + '/' + chosenimg + '.img'):
                            os.replace(j.rd + '/' + chosenimg + '_new.img', j.rd + '/' + chosenimg + '.img')
                            imgname = chosenimg + '.img'
                        else:
                            imgname = chosenimg + '_new.img'

                    j.banner()
                    j.kprint(imgname + ' ' + j.lang['general_create'] + j.romname + '\n', 'g')
                    input(j.lang['enter_build_menu'])
                    choice = ''
                    break
            elif choice == '3':  # START Sign Existing zip
                with j.cd(j.rd):
                    ziplist = j.findf('*.zip')
                ...
                if countzip == 1:
                    ...
                    signzipname = j.chlist(color['gb'] + j.lang['build_cho_zip'], ziplist, countzip)
                    signzipname = signzipname.replace('.zip', '')

                j.banner()
                signzip(signzipname)
                choice = ''
            elif choice == '4':  # START Custom ro.build.display.id
                if 'N/A' in bdisplay:
                    choice = ''
                    continue
                j.banner()
                j.kprint(j.lang['donate_bdisplay'] + '\n')
                bdisplaynew = input().replace(' ', '.')
                if bdid == 'display':
                    j.sedf('ro.build.display.id=' + bdisplay, 'ro.build.display.id=' + bdisplaynew,
                           j.sysdir + '/build.prop')
                elif bdid == 'id':
                    j.sedf('ro.build.id=' + bdisplay, 'ro.build.id=' + bdisplaynew, j.sysdir + '/build.prop')

                choice = ''
            elif choice == '5':  # START Custom zip menu
                build_custom_zip()
                choice = ''
    ...
    def change_permtype():
        ...
        while not choice:
            ...
            if permtype == 'set_metadata':
                j.kprint('1) ' + j.lang['perm_set_metadata_cur'] + ' (' + color['b'] + j.lang['current'] + ')')
            else:
                if api < '19':
                    j.kprint('1) ' + j.lang['perm_set_metadata'], 'r')
                else:
                    j.kprint('1) ' + j.lang['perm_set_metadata'])

            if permtype == 'set_perm':
                j.kprint('2) ' + j.lang['perm_set_perm'] + ' (' + color['b'] + j.lang['current'] + ')')
            else:
                if api > '18':
            ...
            if permtype == 'sparse_dat':
                j.kprint('3) ' + j.lang['perm_sparse'] + ' (' + color['b'] + j.lang['current'] + ')')
            else:
                if api >= '21':
            ...
            if permtype == 'raw_img':
                j.kprint('4) ' + j.lang['perm_raw_img'] + ' (' + color['b'] + j.lang['current'] + ')')
            else:
            ...
            if choice == '1':  # set_metadata chosen
                ...
                if j.getconf('permtype', j.uconf):
                    permtest = j.grepb('#PERM', 'set_progress', j.readfl(j.usdir + '/updater-script'))
                    j.grepvb(permtest, j.usdir + '/updater-script')
                    del permtest

                j.getconf('exdone', j.uconf, 'rem')
                if permtype == 'sparse_dat' or permtype == 'raw_img':
                    j.delpath(j.rd + '/install', j.rd + '/META-INF', j.rd + '/config', j.prfiles + '/set_metadata',
                              j.prfiles + '/set_perm')
                    j.cpdir(j.tools + '/updater/META-INF', j.rd + '/META-INF')
                    j.cp(j.tools + '/updater/binary/update-binary-meta', j.usdir + '/update-binary')
                ...
                j.delpath(j.rd + '/install', j.rd + '/META-INF', j.rd + '/config', j.prfiles + '/set_metadata',
                          j.prfiles + '/set_perm')
                j.getconf('exdone', j.uconf, 'rem')
                j.cpdir(j.tools + '/updater/META-INF-DAT/META-INF', j.rd + '/META-INF')
                j.cp(j.tools + '/updater/binary/update-binary-' + abi, j.usdir + '/update-binary')
                if abi == 'meta':
                    j.configure()
                else:
                ...
                j.delpath(j.rd + '/install', j.rd + '/META-INF', j.rd + '/config', j.prfiles + '/set_metadata',
                          j.prfiles + '/set_perm')
                j.getconf('exdone', j.uconf, 'rem')
                j.cpdir(j.tools + '/updater/META-INF-IMG/META-INF', j.rd + '/META-INF')
                j.cp(j.tools + '/updater/binary/update-binary-meta', j.usdir + '/update-binary')
                j.configure()
    ...
    def choose_img(title):
        ...
        btype = {'boot.img': 'boot', 'kernel.elf': 'boot', 'ramdisk.img': 'boot', 'recovery.img': 'recovery'}
        for i in list(btype):
            if chosen == i:
    ...
    def data_apprem():
        with j.cd(j.usdir):
            j.grepvf('"/data"|"/data/app"|Extracting data|#DATA|data.transfer|data_new.img', 'updater-script')
    ...
    def debloat_rom():
        ...
        def delbloat(debloat, choice2):
            with j.cd(j.rd):
                for i in debloat:
                    ...
                    if j.existf(i):
                        if choice2 == '1':
                            os.replace(i, j.prfiles + os.sep + 'debloated_files' + os.sep + debdir + os.sep + debfile)
                        elif choice2 == '2':
                            j.kprint(i, 'y')
                    elif j.existd(i):
                        if choice2 == '1':
                            j.mvdir(i, j.prfiles + os.sep + 'debloated_files' + os.sep + debdir + os.sep + debfile)
                        elif choice2 == '2':
                            j.kprint(i, 'y')

            j.delpath(j.prfiles + '/db_files', j.prfiles + '/dbc_files', j.prfiles + '/db_knox')
        ...
        def reply2(debtype=''):
            ...
            while not choice2:
                ...
                j.kprint('1) ' + debtype)
                j.kprint('2) ' + j.lang['bloat_list_menu'])
        ...
        while not choice:
            ...
            j.kprint(j.lang['startup_version'] + color['g'] + j.androidversion + '\n', 'b')
            j.kprint(j.lang['menu_rom_debloat'] + '\n', 'ryb')
            j.kprint('1) ' + j.lang['menu_debloat'] + ' (' + color['b'] + j.lang['title_current'] + isdebloatstatus() +
                     color['n'] + ')')
            if not j.existf(j.tools + '/root/bloat_custom') and not j.existf(j.prfiles + '/bloat_custom'):
                j.kprint('2) ' + j.lang['menu_debloat_cust'] + ' (' + isdebcuststatus() + ')')
            else:
                j.kprint('2) ' + j.lang['menu_debloat_cust'] + ' (' + color['b'] + j.lang[
                    'title_current'] + isdebcuststatus() + color['n'] + ')')
            j.kprint(
                '3) ' + j.lang['menu_debloat_knox'] + ' (' + color['b'] + j.lang['title_current'] + isknoxstatus() +
                color['n'] + ')')
            j.kprint('4) ' + j.lang['menu_debloat_restore'])
            j.kprint('5) ' + j.lang['menu_debloat_refresh'])
            j.kprint('6) ' + j.lang['menu_rom_tools'], 'y')
            j.kprint('m = ' + j.lang['title_main'], 'y')
            j.kprint('q = ' + j.lang['menu_quit'] + '\n', 'm')
            j.kprint(j.lang['select'])
            ...
            if choice == 'm':  # START Main Menu
                ...
                j.banner()
                j.kprint(j.lang['bloat_restore_q'])
                reply = j.getChar()
                if reply != 'y':
                    choice = ''
                    continue
                ...
                with j.cd(j.prfiles):
                    j.delpath('debloated_files', 'db_files', 'dbc_files', 'db_knox')
    ...
    def delete_project(curromname):
        ...
        if countdir == 0:
            ...
            chosen = j.chlist(color['yrbbo'] + j.lang['title_delete'] + color['n'], dellist, countdir)
            if not chosen:
                return
        if chosen != 0:
            j.banner()
    ...
    def extract_new():
        def do_sparse_dat(plist):
            ...
            for i in plist:
                ...
                sdat2img.main(line + '.transfer.list', line + '.new.dat', line + '.img')
                j.repout()
        ...
        while loop == 0:
            ...
            if j.autorom():
                j.getconf('signature', j.uconf, add=j.getar('rom_name').replace(' ', '_'))
            ...
            if len(findtmp) > 1:
                project = j.chlist(color['gb'] + j.lang['title_extract'] + color['n'], findtmp, len(findtmp))
                if not project:
                    return
            elif len(findtmp) > 0:
                project = findtmp[0]
            ...
            if not any([romzip, romtar, rommd5, romimg, romwin, romchunk, romtgz, romtgz2, romxz, romdat, romlz4]):
                ...
                while not choice:
                    j.banner()
                    j.kprint(j.lang['startup_project'] + color['g'] + j.romname + '\n', 'b')
                    j.kprint(j.lang['extract_title'] + '\n', 'ryb')
                    j.kprint(j.lang['extract_no_files_message'])
                    j.kprint(j.lang['extract_no_files_message2'])
                    j.kprint(j.lang['extract_no_files_message3'])
                    j.kprint(j.lang['extract_no_files_message4'])
                    j.kprint('m = ' + j.lang['title_main'], 'y')
                    j.kprint('q = ' + j.lang['menu_quit'] + '\n', 'm')
                    choice = j.getChar()
                    ...
                    if choice == 'q':  # START Quit
                        ...
                        while not choice2:
                            ...
                            j.kprint(j.lang['extract_cho_option3'])
                            j.kprint(j.lang['extract_cho_option4'])
                            j.kprint('m = ' + j.lang['title_main'], 'y')
                            j.kprint('q = ' + j.lang['menu_quit'] + '\n', 'm')
                            choice2 = j.getChar()
                            ...
                            if choice2 == 'm':
                                ...
                                sys.exit()
                            elif choice2 == '1':  # booted to custom recovery (stock will not work)
                                j.banner()
                                ...
                                j.banner()
                                j.kprint(j.lang['extract_detect_part'] + '\n', 'b')
                                ...
                                j.appendf(j.cmd(j.adb + ' pull /tmp/srk_config ' + j.prfiles + '/adb_config'),
                                          j.logs + '/adb.log')
                                j.appendf(j.cmd(j.adb + ' shell "rm -rf /tmp/srk_configure.sh /tmp/srk_config"'),
                                          j.logs + '/adb.log')
                                ...
                                if not j.existf(j.prfiles + '/adb_config'):
                                    ...
                                    j.kprint(j.lang['extract_pull_error2'] + '\n', 'r')
                                    input(j.lang['enter_main_menu'])
                                    return
                                ...
                                for i in imglist:
                                    ...
                                    if pulltest != 0:
                                        j.appendf('ERROR: failed to pull ' + i + '.img', j.logs + '/adb.log')
                                        break
                            elif choice2 == '2':  # booted to Android (must be rooted)
                                j.banner()
                                j.kprint(j.lang['byname_usb_debug'] + '\n')
                                j.kprint(j.lang['byname_usb_debug_root'], 'ryb')
                                j.kprint(j.lang['byname_usb_debug_root2'] + '\n', 'r')
                                j.kprint(j.lang['general_continue_q'])
                                reply = j.getChar()
                                if reply != 'y':
                                    choice2 = ''
                                    continue
                                ...
                                j.banner()
                                j.kprint('*** ' + j.lang['extract_detect_part2'], 'y')
                                j.kprint(j.lang['extract_detect_part3'] + ' ***' + '\n', 'y')
                                j.kprint(j.lang['extract_detect_part'] + '\n', 'b')

                                j.appendf(j.cmd(j.adb + ' wait-for-device'), j.logs + '/adb.log')
                                ...
                                j.appendf(j.cmd(j.adb + ' shell su -c "sh /sdcard/srk_configure.sh"'),
                                          j.logs + '/adb.log')
                                j.appendf(j.cmd(j.adb + ' pull /sdcard/srk_config ' + j.prfiles + '/adb_config'),
                                          j.logs + '/adb.log')
                                j.appendf(
                                    j.cmd(j.adb + ' shell su -c "rm -rf /sdcard/srk_configure.sh /sdcard/srk_config"'),
                                    j.logs + '/adb.log')
            ...
            j.banner()
            print(j.lang['extract_q'] + color[
                'y'] + romzip + romtar + rommd5 + romimg + romchunk + romwin + romtgz + romtgz2 + romxz + romdat + romlz4 +
                  color['n'])
            j.kprint(j.lang['extract_q2'])
            ...
            if romzip:
                ...
                if upbinary == '1' and j.greps('.*system/build.prop', ziptest):
                    ...
                    for i in line:
                        part2 = i.split(' ')[1]
                        part3 = i.split(' ')[2]
                        j.appendf('symlink("' + part2 + '", "' + part3 + '");', j.prfiles + '/symlinks-system')
                    ...
                    j.configure()
                    update_project()
                elif j.greps('.*system.new.dat', ziptest):
                    j.sudo_prep()
                    ...
                    with j.cd(j.rd):
                        zipulist = j.greps('.*system.ext4.tar.a|.*system.ext4.tar', ziptest)
                        for i in zipulist:
                            j.appendf(j.zipef(romzip, i), j.logs + '/zip.log')
                    ...
                    if not j.autorom():
                        j.banner()
                        j.kprint(j.lang['extract_extra_extract_q'])
                    ...
                    with j.cd(j.rd):
                        for i in tarulist:
                            ...
                            if i.endswith('.lz4'):
                                j.kprint(j.lang['general_extracting'] + i[:-4] + ' ...', 'y')
                                os.system(j.lz4 + ' -q ' + i)
                                j.delpath(i)
                    ...
                    with j.cd(j.rd):
                        ...
                        for filename in zipulist:
                            ...
                            for i in tarulist:
                                j.kprint(j.lang['general_extracting'] + i + ' ...', 'y')
                                j.appendf(j.taref(filename, i), j.logs + '/zip.log')
                                if i.endswith('.lz4'):
                                    j.kprint(j.lang['general_extracting'] + i[:-4] + ' ...', 'y')
                                    os.system(j.lz4 + ' -q ' + i)
                                    j.delpath(i)
                    ...
                    if j.existf(j.rd + '/system.img') or j.existf(j.rd + '/super.img'):
                        if j.existf(j.rd + '/system.img'):
                            romimg = 'system.img'
                        else:
                            romimg = 'super.img'
                    ...
                    romzip = ''
                elif j.greps('.*.img.lz4', ziptest):
                    j.sudo_prep()

                    zipulist = j.greps('.*.img.lz4|.*boot.img', ziptest)
                    ...
                    with j.cd(j.rd):
                        ...
                        romzip = ''
                        romchunk = sorted(j.grepv('system_other', j.findf('*system*chunk*')))
                    ...
                    with j.cd(j.rd):
                        zipulist = j.greps('.*payload.bin|.*file_contexts|.*file_contexts.bin', ziptest)
                        for i in zipulist:
                            j.appendf(j.zipef(romzip, i), j.logs + '/zip.log')

                        import pbin_dump
                        pbin_dump.main('payload.bin', 'boot', 'cache', *j.partslist)
                ...
                if romzip:
                    ...
                    ptest = [j.existf(j.rd + '/system/build.prop'), j.existf(j.rd + '/system/system/build.prop')]
            ...
            if romchunk:
                ...
                if 'sparsechunk' in romchunk or 'sparsechunk' in romchunk[0]:
                    with j.cd(j.rd):
                        j.appendf(j.cmd(j.simg2img + ' ' + ' '.join(romchunk) + ' system.img.raw'),
                                  j.logs + '/main.log')

                        for i in j.partslist:
                            tmpchunk = j.findf(i + '.img_sparsechunk*')
                            if tmpchunk:
                                j.appendf(j.cmd(j.simg2img + ' ' + ' '.join(tmpchunk) + ' ' + i + '.img.raw'),
                                          j.logs + '/main.log')

                        for rimg in [x + '.img.raw' for x in j.partslist]:
                            if j.existf(rimg):
                                j.delpath(*j.findf(rimg.replace('.img.raw', '') + '*chunk*'))
                                ...
                                if offset > 0:
                                    j.banner()
                                    j.kprint(j.lang['extract_fix_img'] + rimg.replace('.raw', '') + ' ...', 'b')
                    ...
                    with j.cd(j.rd):
                        j.appendf(j.cmd(j.simg2img + ' *chunk* system.img'), j.logs + '/main.log')
            ...
            if romtgz:
                ...
                with j.cd(j.rd):
                    if extype == 'tgz':
                        ...
                        j.appendf(j.zipef(romtgz, eximage, eximage), j.logs + '/zip.log')
                    ...
                    with j.cd(exdir):
                        ...
                        for i in ziplist:
                            try:
                                j.appendf(j.zipef(imagezip, i), j.logs + '/zip.log')
                                os.replace(i, j.rd + '/' + i)
                            except:
                                pass
            ...
            if romtgz2:
                ...
                with j.cd(j.rd):
                    ...
                    tarulist = j.greps('.*' + '.img|.*'.join(j.partslist) + '.img|.*boot.img',
                                       j.findr('tmptar/**/*.img'))
            ...
            if rommd5:
                with j.cd(j.rd):
                    ...
                    if j.greps('.*super.*\.img|.*system.*\.img|.*system.*ext4', tartest):
                        ...
                        with j.cd(j.rd):
                            for i in tarulist:
                                j.appendf(j.taref(rommd5, i), j.logs + '/zip.log')
                            j.imgrename()
            ...
            if romtar:
                ...
                if j.greps('.*.img.lz4', tartest):
                    ...
                    try:
                        with j.cd(j.rd):
                            tar_ef = j.greps('.* /bin', j.cmd(j.tar + ' --numeric-owner -tvf ' + romtar).splitlines())[
                                0].split()[1]
                    except:
                        tar_ef = None
                    ...
                    with j.cd(j.rd):
                        if not partition in tartest[0]:
                            j.appendf(j.taru(romtar, partition), j.logs + '/zip.log')
            ...
            if romimg:
                ...
                if romimg == 'super.img':
                    with j.cd(j.rd):
                        if j.sparse_chk(romimg):
                            j.sparse_conv(romimg)
                            j.sudo_prep(quiet=1)

                        if j.platf == 'mac':
                            if not j.cmd('which openssl'):
                                j.banner()
                                j.kprint(j.lang['error'], 'yrbbo')
                                j.kprint(
                        ...
                        j.banner()
                        j.kprint(j.lang['boot_unpack'] + 'super.img ...', 'b')

                        j.getconf('supersize', j.uconf, add=str(j.fsize(romimg)))

                        j.appendf(j.cmd(j.superx + ' -K H4dEuE7ETGps6AUv ' + romimg), j.logs + '/main.log')
                        ...
                        if j.existf('system.img'):
                            ...
                            j.banner()
                            j.kprint(j.lang['error'], 'yrbbo')
                            j.kprint('super.img: ' + j.lang['extract_fail'] + '\n', 'r')
                            input(j.lang['enter_main_menu'])
                            return

                romimgdir = romimg.replace('.img', '')
                j.delpath(j.prfiles + '/symlinks-' + romimgdir, j.prfiles + '/symlinks-' + romimgdir + '.orig')
                ...
                if j.existf(j.sysdir + '/build.prop'):
                    ...
                    if j.existf(j.rd + '/cache.img'):
                        ...
                        if not j.autorom() and ex_all_img != 'Yes':
                            j.banner()
                            j.kprint(j.lang['extract_cache_extract_q'])
                            reply = j.getChar()
                        else:
                        ...
                        if reply == 'y':
                            ...
                            if j.existd(j.rd + '/cache') and (
                                ...
                                if not j.autorom() and ex_all_img != 'Yes':
                                    ...
                                    j.kprint(j.lang['extract_cache_include_q2'])
                                    reply = j.getChar()
                                ...
                                if reply == 'y':
                                    ...
                                    with j.cd(j.rd + '/cache'):
                                        ...
                                        if j.greps('.*\.zip', cscfull):
                                            ...
                                            with j.cd(cscdir):
                                                j.appendf(j.zipu(csczip), j.logs + '/zip.log')
                                                with j.cd('system'):
                                                    for i in j.findf('*'):
                                                        if j.existd(i):
                                                            j.mvdir(i, j.sysdir + '/' + i)
                                                        else:
                                                            os.replace(i, j.sysdir + '/' + i)
                                        else:
                                            if not j.autorom() and ex_all_img != 'Yes':
                                                j.banner()
                                                j.kprint(j.lang['error'], 'yrbbo')
                                                j.kprint(j.lang['extract_cache_fail'] + '\n', 'r')
                                                input(j.lang['enter_continue'])

                                    j.delpath(j.rd + '/cache')
                    elif j.existf(j.rd + '/system_other.img'):
                        j.banner()
                        j.kprint(j.lang['general_extracting'] + 'system_other.img ...', 'b')
                        ...
                        with j.cd(j.rd):
                            ...
                            for i in j.findr('system/**'):
                                ...
                                j.mkdir(j.dirname(i).replace('system', rep_val, 1))
                                    ...
                                    if j.autorom():
                                        if line2 in ['vendor', 'oem', 'odm', 'product', 'system_ext']:
                                            if j.getar('vendor_img') == 'true':
                                                ...
                                                j.getconf('exdirs', j.uconf,
                                                          add=j.getconf('exdirs', j.uconf, l=1) + [line2], l=1)
                                    ...
                                    if reply == 'y':
                                        ...
                                        if j.existd(line2):
                                            ...
                                            if ex_all_img != 'Yes':
                                                ...
                                                j.kprint(line + j.lang['extract_extra_include_q'])
                                                reply = j.getChar()

                                            if reply == 'y':
                                                curr_exdirs = j.getconf('exdirs', j.uconf, l=1)
                                                if line2 not in curr_exdirs:
                                                    j.getconf('exdirs', j.uconf, add=curr_exdirs + [line2], l=1)
                                else:
                                    if line.endswith('.img'):
                                        j.imgextract(line)
                                    else:
                    ...
                    if j.existd(j.rd + '/system'):
                        ...
                        j.cp(j.tools + '/updater/binary/update-binary-meta', j.usdir + '/update-binary')
                        j.configure()
                        j.delpath(j.prfiles + '/debloat_test', j.prfiles + '/debloat_test_custom')
                        update_project()
                else:
                    j.banner()
                    j.kprint(j.lang['error'], 'yrbbo')
            ...
            if j.autorom():
                ...
                if j.getar('verity_rem') or j.getar('force_rem'):
                    btype = {'boot.img': 'boot', 'kernel.elf': 'boot', 'ramdisk.img': 'boot'}
                    for i in list(btype):
                        if j.existf(j.rd + '/' + i):
                            chosenimg = btype[i]
                            chosenimg2 = i
                    ...
                    if j.getar('verity_rem'):
                        with j.cd(j.bd):
                            j.appendf(j.cmd(j.rampy(chosenimg) + 'dmverity ' + j.romname + ' boot'),
                                      j.logs + '/boot.log')
                    if j.getar('force_rem'):
                        with j.cd(j.bd):
                            j.appendf(j.cmd(j.rampy(chosenimg) + 'forcee ' + j.romname + ' boot'), j.logs + '/boot.log')
    ...
    def get_byname():
        ...
        while not choice:
            j.banner()
            j.kprint(j.lang['byname_how_to_get_q'] + '\n')
            j.kprint('1) ' + j.lang['menu_byname_detect_boot'])
            j.kprint('2) ' + j.lang['menu_byname_detect_device'])
            j.kprint('3) ' + j.lang['menu_byname_detect_manual'])
            j.kprint('4) ' + j.lang['menu_byname_detect_mmc'])
            ...
            if choice == '1':  # START Detect by-name from the boot.img
                ...
                if not j.existf(deviceloc + '/superr_byname'):
                    with j.cd(j.bd):
                        j.appendf(j.cmd(j.rampy(chosenimg) + 'byname ' + j.romname + ' ' + chosenimg),
                                  j.logs + '/boot.log')
                ...
                if not j.existf(deviceloc + '/superr_byname'):
                    ...
                    j.kprint(j.lang['byname_try_recovery'] + '\n')
                    input(j.lang['enter_continue'])
                    j.delpath(deviceloc + '/superr_byname')
                    choice = ''
                    continue
                ...
                j.banner()
                j.kprint(j.lang['byname_detect_manual'] + '\n')
                j.kprint(j.lang['example'] + '\n', 'gb')
                ...
                with j.cd(j.bd):
                    j.appendf(j.cmd(j.rampy('recovery') + 'mmc ' + j.romname + ' recovery'), j.logs + '/boot.log')
                ...
                if j.existf(deviceloc + '/superr_mmc'):
                    ...
                    j.kprint(j.lang['byname_try_boot'] + '\n')
                    input(j.lang['enter_continue'])
                    choice = ''
                    continue
    ...
    def ext_dirmenu():
        ...
        while not choice:
            if j.getconf('custom_dir', j.uconf):
                cctr = color['g'] + ', '.join(j.getconf('custom_dir', j.uconf, l=1))
            else:
            ...
            j.kprint(
                '1) ' + j.lang['menu_data'] + ' (' + color['b'] + j.lang['title_current'] + color['g'] + isdataapp() +
                color['n'] + ')')
            j.kprint(
                '2) ' + j.lang['menu_cust_dir'] + ' (' + color['b'] + j.lang['title_current'] + cctr + color['n'] + ')')
            ...
            if choice == 'm':  # START Main Menu
                ...
                if 'Enabled' not in isdataapp():
                    ...
                    j.kprint(j.lang['extra_already_data3'])
                    reply = j.getChar()
                    if reply == 'y':
                        data_apprem()
                        j.banner()
                ...
                while not cusname:
                    j.banner()
                    j.kprint(j.lang['extra_cust_name'] + '\n')
                ...
                if cusname in j.getconf('custom_dir', j.uconf, l=1):
                    ...
                    j.kprint(j.lang['general_remove_q'])
                    reply = j.getChar()
                ...
                if j.getconf('custom_dir', j.uconf):
                    j.getconf('custom_dir', j.uconf, add=j.getconf('custom_dir', j.uconf, l=1) + [cusname], l=1)
                else:
                    j.getconf('custom_dir', j.uconf, add=cusname)

                j.banner()
                j.kprint(cusname + j.lang['extra_cust_name_q'])
                reply = j.getChar()
                if reply == 'y':
                    j.banner()
                    j.kprint(j.lang['extra_cust_loc'] + '\n')
                    j.kprint(j.lang['example'], 'gbbo')
                    j.kprint('/system\n', 'y')
                    cusloc = input()
                    ...
                    if not j.grepf('#CUSTOM', j.usdir + '/updater-script'):
                        ...
                        if permtype == 'sparse_dat':
                            ...
                            j.awkadd('^package_extract_dir.*"system"', '#CUSTOM', 'after', 'first',
                                     j.usdir + '/updater-script')

                    if cusloc.startswith('/'):
                        cusloc = cusloc[1:]

                    j.sedf('#CUSTOM', j.readf(j.tools + '/updater/custom_dir.txt'), j.usdir + '/updater-script')
    ...
    def isassert():
        ...
        if j.existf(j.usdir + '/updater-script'):
            if j.grepf(j.fl('abort', '.*ERROR'), j.usdir + '/updater-script'):
                assertdevices = j.grepf('abort', j.usdir + '/updater-script')[0].split('"')[2].replace('\\', '')
                if assertdevices:
                    j.getconf('assertdevices', j.uconf, add=assertdevices)
                else:
                    j.getconf('assertdevices', j.uconf, add='None')

                acuststat = j.grepf(j.fl('assert.*', '.*ro.product.device.*'), j.usdir + '/updater-script')
                if acuststat:
                    ctest = []
                    ctmp = []
                    for i in acuststat:
    ...
    def isfullrom():
        ...
        if j.existd(j.sysdir):
            dirtmp = [j.sysdir + '/lib', j.sysdir + '/etc', j.sysdir + '/bin', j.rd + '/META-INF']
            fullrom = 'Yes'
            for i in dirtmp:
                if not j.existd(i):
                    fullrom = 'No'
            ...
            if fullrom == 'Yes':
                if not j.getconf('noboot', j.uconf):
                    ...
                    if not thechk:
                        j.banner()
                        j.kprint(j.lang['build_no_boot_q'])
                        j.kprint(j.lang['build_no_boot_q2'])
                        reply = j.getChar()
                        if reply != 'y':
                            fullrom = 'No'
                        else:
                            j.getconf('noboot', j.uconf, add='1')
                            j.grepvf('boot.img|boot image|kernel.img|kernel image|ramdisk.img|ramdisk image',
                                     j.usdir + '/updater-script')
                            fullrom = 'Yes'
        return fullrom
    ...
    def language_check(lang1):
        j.banner()
        j.kprint(f'Checking language file {lang1} ...', 'b')

        lang_add = []
        with open(j.tools + f'/language/{lang1}_srk.py', 'r', encoding='utf-8') as f:
            data = [i.split(' = ')[0] for i in f.readlines() if " = " in i]
            for i in j.readfl(j.tools + '/language/english_srk.py'):
                ...
                if line2 not in data:
                    lang_add.append(i)
        if lang_add:
            j.appendf('\n# Needs translation', j.tools + '/language/' + lang1 + '_srk.py')
            for i in lang_add:
                j.appendf(i, j.tools + '/language/' + lang1 + '_srk.py')
            return 1
        else:
            return 0
    ...
    def metasetup(extractdir):
        def dirmeta(idir):
            try:
                rider = j.greps('^' + dirr + extractdir + '/' + idir + ' ', filer)[0].split()
                if rider:
                    try:
                    ...
                    if j.getconf('metasize', j.mconf) != 'Long':
                        ...
                        nocon.append('.*:' + j.greps(rider[0] + ' ', fcontexts).split(':')[2])

                    riders = j.greps('^' + dirr + extractdir + '/' + idir + '.*', filer)[1:]
        ...
        if extractdir == 'system':
            ...
            if j.sar():
                ...
                if 'system/system' in roottmp: roottmp.remove('system/system')
        ...
        if not capfiles:
            ...
            if devicename:
                ...
                if j.existf(deviceloc + '/capfiles-' + api):
                    capfiles = j.greps('^' + extractdir + ' ', j.grepf('=', deviceloc + '/capfiles-' + api))
                else:
                    capfiles = []
        ...
        ugid = ' '.join(j.greps('^' + dirr + extractdir + ' ', filer)[0].split()[-3:-1])
        ...
        for i in metalist:
            ...
            if a:
                ...
                if i.endswith('-R'):
                    ...
                    newmlist.append(
                        'set_metadata_recursive("/' + dirr + i2 + '", "uid", ' + cyuid + ', "gid", ' + cygid + ', "dmode", ' + cymode + ', "fmode", ' + fmode + ', "capabilities", ' + cap + ', "selabel", "' + cycon + '");')
                else:
                    newmlist.append(
    ...
    def misc_tools():
        ...
        while not choice:
            ...
            j.kprint(j.lang['startup_project'] + color['g'] + j.romname, 'b')
            if j.existf(j.sysdir + '/build.prop'):
                j.kprint(j.lang['startup_version'] + color['g'] + j.androidversion, 'b')
            else:
                j.kprint(j.lang['startup_version'] + color['r'] + j.lang['startup_title_no_rom'], 'b')

            print()
            j.kprint(j.lang['title_misc'] + '\n', 'ryb')
            j.kprint('1) ' + j.lang['menu_offline_auth'] + ' (' + color['b'] + j.lang['expires'] + color['g'] +
                     j.days_left.split('-')[0] + color['n'] + ')')
            j.kprint('2) ' + j.lang['menu_language'] + ' (' + color['b'] + j.lang['title_current'] + language + color[
                'n'] + ')')
            j.kprint('3) ' + j.lang['menu_heapsize'] + ' (' + color['b'] + j.lang['title_current'] + color[
                'g'] + heapstatus + color['n'] + ')')
            j.kprint('4) ' + j.lang['menu_support'])
            ...
            if choice == '1':  # START Offline Authorization Menu
                ...
                while not choice2:
                    ...
                    j.kprint(j.lang['auth_max_days'] + str(j.auth_days) + '\n', 'y')
                    j.kprint('1) ' + j.lang['menu_offline_enable'] + ' (' + color['b'] + j.lang[
                        'title_current'] + offline_status + color['n'] + ')')
                    if j.getconf('offline_auth', j.mconf) == 'enabled':
                        cnt = '2'
                        j.kprint(
                            '2) ' + j.lang['menu_offline_renew'] + ' (' + color['b'] + j.lang['expires'] + color['g'] +
                            j.days_left.split('-')[0] + color['n'] + ')')
                ...
                while not choice2:
                    ...
                    j.kprint('1) ' + j.lang['heapsize_custom'] + ' (' + color['b'] + j.lang['title_current'] + color[
                        'g'] + heapstatus + color['n'] + ')')
                    j.kprint('2) ' + j.lang['heapsize_reset'])
                    j.kprint('b = ' + j.lang['menu_back'] + '\n', 'y')
                    j.kprint(j.lang['select'])
                    choice2 = j.getChar()
                    ...
                    if choice2 == 'b':
                        ...
                        j.kprint(j.lang['heapsize_q'])
                        j.kprint(j.lang['heapsize_q2'] + color['y'] + str(totalmem))
                        reply = input()
                        if reply.isnumeric():
                            if int(reply) > totalmem:
                                ...
                                j.kprint(j.lang['physical_ram'] + str(totalmem) + '\n', 'y')
                ...
                if not j.getconf('xdauser', j.mconf):
                    j.banner()
                    j.kprint(j.lang['xdauser_q'])
                    j.getconf('xdauser', j.mconf, add=input().replace(' ', '_') or 'guest')
                ...
                while not choice2:
                    ...
                    j.kprint('1) ' + j.lang['menu_mount_extract'] + ' (' + color['b'] + j.lang['title_current'] + color[
                        'g'] + mountstatus + color['n'] + ')', ('r' if j.platf in ['win', 'wsl'] else 'n'))
                    j.kprint('2) ' + j.lang['menu_case_fix'] + ' (' + color['b'] + j.lang['title_current'] + color[
                        'g'] + casestatus + color['n'] + ')', 'n')
                    j.kprint(
                        '3) ' + j.lang['menu_extract_all_img'] + ' (' + color['b'] + j.lang['title_current'] + color[
                            'g'] + imgstatus + color['n'] + ')', 'n')
                    j.kprint('b = ' + j.lang['menu_back'] + '\n', 'y')
                    j.kprint(j.lang['select'])
                    choice2 = j.getChar()
                ...
                while not choice2:
                    ...
                    j.kprint('3) ' + j.lang['menu_ubinary'])
                    j.kprint('4) ' + j.lang['brotli_menu'])
                    j.kprint('b = ' + j.lang['menu_back'], 'y')
                    j.kprint('q = ' + j.lang['menu_quit'] + '\n', 'm')
                    j.kprint(j.lang['select'])
                    choice2 = j.getChar()
                    ...
                    if choice2 == 'q':  # START Quit
                        ...
                        while not choice3:
                            ...
                            j.banner()
                            j.kprint(j.lang['title_current'] + color['g'] + slstat + '\n', 'b')
                            j.kprint(j.lang['metasize_q'] + '\n', 'gb')
                            j.kprint('1) ' + j.lang['metasize_s'])
                            j.kprint('2) ' + j.lang['metasize_l'])
                            j.kprint('b = ' + j.lang['menu_back'] + '\n', 'y')
                            j.kprint(j.lang['select'])
                            choice3 = j.getChar()
                        ...
                        while True:
                            j.banner()
                            j.kprint(j.lang['menu_zip_compression2'] + '(0,1,3,5,7,9):')
                        ...
                        while not choice3:
                            ...
                            j.kprint(j.lang['title_current'] + color['g'] + ubstat + '\n', 'b')
                            j.kprint('1) ' + j.lang['ask_b'])
                            j.kprint('2) ' + j.lang['always_b'])
                            j.kprint('3) ' + j.lang['never_b'])
                            j.kprint('b = ' + j.lang['menu_back'], 'y')
                            j.kprint('q = ' + j.lang['menu_quit'] + '\n', 'm')
                            j.kprint(j.lang['select'])
                            choice3 = j.getChar()
                        ...
                        while not choice3:
                            ...
                            if not j.getconf('brotli_comp', j.mconf):
                                ...
                                j.kprint(j.lang['title_current'] + color['g'] + slstat, 'b')

                            print()
                            j.kprint(j.lang['brotli_q'] + '\n', 'gb')
                            j.kprint('1) ' + j.lang['yes'])
                            j.kprint('2) ' + j.lang['no'])
                            j.kprint('b = ' + j.lang['menu_back'] + '\n', 'y')
                            j.kprint(j.lang['select'])
                            choice3 = j.getChar()
                            ...
                            if choice3 == '1':
                                while True:
                                    j.banner()
                                    j.kprint(j.lang['brotli_level'] + '(0-9):')

                                    comp7 = j.getChar()
                                    if comp7.isnumeric() and comp7 <= '9':
                                        j.getconf('brotli_comp', j.mconf, add=comp7)
                                    else:
                                        continue
    ...
    def moveoldfiles(romzip, romtar, romimg, romdat):
        timestamp = j.timest()
        movetest = j.partslist + ['install', 'META-INF', 'supersu', 'rootzip', 'busybox', 'gapps', 'xposed', 'magisk',
                                  'mod', 'data', 'bootimg', 'recoveryimg']
        mvtmp = []
        for i in movetest:
            if j.existd(j.rd + '/' + i):
                mvtmp.append(i)
        if mvtmp:
            j.mkdir(j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp + '/00_project_files')
            with j.cd(j.prfiles):
                prtmp = j.findf('*')
                prtmp.remove('old_rom_files')
                for i in prtmp:
                    if j.existd(i):
                        j.mvdir(i, 'old_rom_files/' + j.romname + '.' + timestamp + '/00_project_files/' + i)
                    else:
                        os.replace(i, 'old_rom_files/' + j.romname + '.' + timestamp + '/00_project_files/' + i)
                j.mkdir('logs')

            for i in mvtmp:
                j.mvdir(j.rd + '/' + i, j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp + '/' + i)

            if romzip:
                ziptmp = ['boot.img', 'system.img.ext4', 'system.ext4', 'cache.img', 'cache.ext4', 'kernel.img',
                          'ramdisk.img'] + [x + '.img' for x in j.partslist]
                ztmp = []
                for i in ziptmp:
                ...
                if ztmp:
                    if not j.existd(j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp):
                        j.mkdir(j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp)

                    for i in ztmp:
                        os.replace(j.rd + '/' + i,
                                   j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp + '/' + i)
            ...
            if j.existd(j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp):
                ...
                j.kprint(j.prfiles + '/old_rom_files/' + j.romname + '.' + timestamp + '\n', 'y')
                j.kprint(', '.join(movelist) + '\n', 'y')
                j.kprint(j.lang['enter_continue_extracting'] + ' ' + romzip + romtar + romimg + romdat + ' ...')
                input()
        ...
        if partbyname:
            if permtype in ['sparse_dat', 'raw_img']:
                if not j.grepf('.*/tmp/config", "' + whatimg + '"', j.usdir + '/updater-script'):
                    j.awkadd('#MOUNT',
                             'ifelse(is_mounted("/' + whatimg + '"), "", mount("ext4", "EMMC", file_getprop("/tmp/config", "' + whatimg + '"), "/' + whatimg + '"));',
                             'after', 'all', j.usdir + '/updater-script')

                    j.awkadd('#UNMOUNT', 'ifelse(is_mounted("/' + whatimg + '"), unmount("/' + whatimg + '"));',
                             'after', 'all', j.usdir + '/updater-script')
                ...
                if whatimg in j.getconf('exdirs', j.uconf, l=1):
                    ...
                    j.sedf('#' + partup, j.readf(j.tools + '/updater/extra-' + permtype + '.txt'),
                           j.usdir + '/updater-script')
                    ...
                    while not choice2:
                        ...
                        j.kprint('1) ' + permtype)
                        j.kprint('2) set_metadata\n')
                        j.kprint(j.lang['extra_data_perm'])
                        choice2 = j.getChar()
                        ...
                        if choice2 == '1':  # START sparse_dat/raw_img data
                            j.sedf('#DATA', j.readf(j.tools + '/updater/data-' + permtype + '.txt'),
                                   j.usdir + '/updater-script')
                            j.getconf('data-' + permtype, j.uconf, add='1')
                        elif choice2 == '2':  # START metadata data
                            j.sedf('#DATA', j.readf(j.tools + '/updater/data-set_metadata.txt'),
                                   j.usdir + '/updater-script')
                ...
                if not j.grepf('.*/tmp/config", "' + whatimg + '"', j.usdir + '/updater-script'):
                    ...
                    if whatimg != 'data':
                        j.awkadd('^format.*', '#FORMAT', 'after', 'first', j.usdir + '/updater-script')
                        j.sedf('#FORMAT',
                               'format("ext4", "EMMC", file_getprop("/tmp/config", "' + whatimg + '"), "0", "/' + whatimg + '");',
                               j.usdir + '/updater-script')
                ...
                if whatimg in j.getconf('exdirs', j.uconf, l=1):
                    ...
                    if whatimg in ['vendor', 'oem', 'product']:
                        j.sedf('#' + partup, j.readf(j.tools + '/updater/vendor-set_metadata.txt'),
                               j.usdir + '/updater-script')
                    else:
                        j.sedf('#' + partup, j.readf(j.tools + '/updater/extra-set_metadata.txt'),
                               j.usdir + '/updater-script')
            ...
            if '_exfiles' in whatimg2 and permtype in ['set_metadata', 'set_perm']:
                if not j.grepf('#EXFILES', j.usdir + '/updater-script'):
                    j.awkadd('^package_extract_dir.*"system"', '#EXFILES', 'after', 'first',
                             j.usdir + '/updater-script')

                    j.sedf('#EXFILES', j.readf(j.tools + '/updater/custom_dir.txt'), j.usdir + '/updater-script')
                    j.sedf('#CUSDIR', whatimg2, j.usdir + '/updater-script')
                    if whatimg == 'system':
                        j.sedf('"/#CUSLOC"', 'file_getprop("/tmp/config", "sysmnt")', j.usdir + '/updater-script')
    ...
    def plugins():
        ...
        while not choice:
            ...
            if choice == '1':  # START Run a plugin
                ...
                if countplug > 0:
                    plugin = j.chlist(color['gb'] + j.lang['donate_plugin_cho'] + color['n'], plugins, countplug)
                    if not plugin:
                        choice = ''
                        continue
                else:
                ...
                if (j.existf(j.tools + '/plugins/' + plugin + '/' + plugin)
                        or j.existf(j.tools + '/plugins/' + plugin + '/' + plugin + '.py')
                    ...
                    # Delete variables for plugin use
                    del j.dbtst, j.srkuser, j.srkpass, j.server1, j.auth_days, j.days_left

                    try:
                        if j.existf(j.tools + '/plugins/' + plugin + '/' + plugin + '.py'):
                            sys.path.append(os.path.abspath(j.tools + '/plugins/' + plugin))
                            ...
                            if j.platf in ['lin', 'mac', 'wsl', 'wsl2']:
                                os.system(
                                    j.tools + '/plugins/' + plugin + '/' + plugin + '.sh "' + j.bd + '" "' + j.ostools + '" "' + j.rd + '" "' + j.tools + '/plugins/' + plugin + '"')
                            else:
                                plug_incompat()
                        elif j.existf(j.tools + '/plugins/' + plugin + '/' + plugin + '.bat'):
                            if j.platf == 'win':
                                os.system(
                                    j.tools + os.sep + 'plugins' + os.sep + plugin + os.sep + plugin + '.bat "' + j.bd + '" "' + j.ostools + '" "' + j.rd + '" "' + j.tools + os.sep + 'plugins' + os.sep + plugin + '"')
                            else:
                                plug_incompat()
                        else:
                    ...
                    # Delete tmp variables removed for plugin use
                    del dbtst, srkuser, srkpass, server1, auth_days, days_left
                else:
                    j.banner()
                    j.kprint(j.lang['error'], 'yrbbo')
                    ...
                    j.kprint('/kitchen/tools/plugins/pluginname/pluginname.py\n\nOR\n', 'y')
                    if j.platf == 'win':
                        j.kprint('/kitchen/tools/plugins/pluginname/pluginname.bat\n', 'y')
                    else:
                        j.kprint('/kitchen/tools/plugins/pluginname/pluginname.sh\n', 'y')
                ...
                if countplug >= 1:
                    plug = j.chlist(color['gb'] + j.lang['donate_plugin_install_cho'] + color['n'], pluglist, countplug)
                    if not plug:
                        choice = ''
                        continue
                else:
                ...
                if countplug >= 1:
                    plugin = j.chlist(color['rb'] + j.lang['donate_plugin_delete_cho'] + color['n'], plugins2,
                                      countplug)
                    if not plugin:
                        choice = ''
                        continue
    ...
    def pullimga(pullimg, byname):
        ...
        j.appendf(j.cmd(j.adb + ' exec-out su -c "cat ' + byname + '" > ' + j.rd + '/' + pullimg + '.img'),
                  j.logs + '/adb.log')
    ...
    def pullimgr(pullimg, byname):
        ...
        j.appendf(j.cmd(j.adb + ' pull ' + byname + ' ' + pullimg + '.img'), j.logs + '/adb.log')
    ...
    def rom_tools():
        ...
        while main == 0:
            ...
            j.kprint(
                '1) ' + j.lang['menu_deodex'] + '(' + color['b'] + j.lang['title_current'] + j.isodexstatus() + color[
                    'n'] + ')')
            j.kprint(
                '2) ' + j.lang['menu_perm_type'] + '(' + color['b'] + j.lang['title_current'] + color['g'] + permtype +
                color['n'] + ')')
            ...
            if choice == 'q':  # START Quit
                ...
                j.deodex_start()
            elif choice == '2':  # START Change perm type (set_perm/set_metadata)
                change_permtype()
    ...
    def root():
        ...
        while not choice:
            if j.autorom():
                ...
                j.banner()
                j.kprint(j.lang['menu_root_method'] + '\n')
                j.kprint('1) Magisk')
                j.kprint('2) SuperSU')
                j.kprint('3) Other')
                j.kprint('b = ' + j.lang['menu_back'], 'y')
        ...
        with j.cd(j.tools + '/root/root_zips'):
            if rootver == 'Other':
                rootzip = j.greps(j.fl('', '.*SuperSU|.*Magisk'), j.findf('*.zip'))
            else:
            ...
            if not rootzip:
                ...
                if rootver == 'SuperSU':
                    ...
                    rootdl = 'https://github.com' + j.greps('.*Magisk-v',
                                                            j.internet('https://github.com/topjohnwu/Magisk/releases',
        ...
        if len(rootzip) == 1:
            ...
            rootzip = j.chlist(color['gb'] + j.lang['title_cho_root_zip'] + color['n'], rootzip, len(rootzip))
            ...
            if api >= '23' or (j.androidversion == '5.1.1' and stest == 'samsung'):
                ...
                while not choice:
                    ...
                    if j.autorom():
                        ...
                        j.banner()
                        j.kprint(j.lang['menu_ss_method'] + '\n')
                        j.kprint('1) ' + j.lang['menu_supersucho'])
                        j.kprint('2) ' + j.lang['menu_system_install'])
                        if j.platf == 'lin':
                            rcnt = '3'
                            if j.existd(j.tools + '/inject-sepolicy'):
                                j.kprint('3) ' + j.lang['menu_inject'])
                            else:
                                j.kprint('3) ' + j.lang['menu_download_inject'])
                    ...
                    if choice == 'q':
                        ...
                        if not j.existd(j.tools + '/inject-sepolicy'):
                            with j.cd(j.tools):
                                ...
                                j.appendf(j.zipu('inject-sepolicy-addon.zip'), j.logs + '/zip.log')
    ...
    def rootrem():
        ...
        testf = [j.sysdir + '/bin/install-recovery.sh', j.sysdir + '/etc/install-recovery.sh']
        for i in testf:
        ...
        if not bbpath:
            with j.cd(j.tools + '/root/busybox'):
                ...
                try:
                    ...
                    bbdl = 'https://forum.xda-developers.com' + j.greps('UPDATE-Busybox', bbdl)[0].split('"')[1]
        ...
        with j.cd(j.usdir):
            if bbpath:
                ...
                if not j.grepf('^#BUSYBOX', 'updater-script'):
                    j.awkadd('#ROOT', '#BUSYBOX', 'after', 'last', 'updater-script')
    ...
    def root_tools():
        ...
        while main == 0:
            ...
            j.kprint(j.lang['startup_project'] + color['g'] + j.romname, 'b')
            j.kprint(j.lang['startup_version'] + color['g'] + j.androidversion + '\n', 'b')
            j.kprint(color['ryb'] + j.lang['menu_root'] + '\n')
            j.kprint('1) ' + j.lang['menu_root_unroot'] + ' (' + color['b'] + j.lang['title_current'] + color[
                'g'] + isrootstatus() + color['n'] + ')')
            j.kprint('2) ' + j.lang['menu_busybox'] + ' (' + color['b'] + j.lang['title_current'] + color[
                'g'] + isbusyboxstatus() + color['n'] + ')')
            j.kprint(
                '3) ' + j.lang['menu_add_remove_sud'] + ' (' + color['b'] + j.lang['title_current'] + issud() + color[
                    'n'] + ')')
            ...
            if choice == 'q':
                ...
                if j.getconf('root', j.uconf):
                    if not j.getconf('sud', j.uconf):
                        j.banner()
                        j.kprint(j.lang['root_sud_add_q'])
                        reply = j.getChar()
                        if reply != 'y':
                            continue
                        root_sud()
                        ...
                        j.banner()
                        j.kprint(j.lang['root_sud_rem_q'])
                        reply = j.getChar()
                        if reply != 'y':
                            continue
                        root_sudrem()
    ...
    def signzip(signzipname, signext=None):
        ...
        if reply == 'y':
            ...
            if not j.autorom() and ramest > heapsize:
                ...
                j.kprint(j.lang['deodex_try_anyway'])
                reply = j.getChar()
                if reply != 'y':
                    return
            ...
            with j.cd(j.rd):
                j.appendf(j.cmd('java -Xmx' + str(
                    heapsize) + 'm -jar ' + j.tools + '/signapk/signapk.jar -w ' + j.tools + '/signapk/testkey.x509.pem ' + j.tools + '/signapk/testkey.pk8 ' + signzipname + '.zip ' + signzipname + '-signed.zip'),
                          j.logs + '/sign.log')
                ubtmp = j.greps('.*update-binary', j.zipl(signzipname + '.zip'))
                if ubtmp:
                    j.appendf(j.zipef(signzipname + '.zip', ubtmp[0]), j.logs + '/zip.log')
                ...
                if bintxt:
                    j.appendf(
                        j.cmd(j.zipadjust + ' ' + signzipname + '-signed.zip ' + signzipname + '-signed-fixed.zip'),
                        j.logs + '/sign.log')
                    j.appendf(j.cmd('java -Xmx' + str(
                        heapsize) + 'm -jar ' + j.tools + '/signapk/minsignapk.jar ' + j.tools + '/signapk/testkey.x509.pem ' + j.tools + '/signapk/testkey.pk8 ' + signzipname + '-signed-fixed.zip ' + signzipname + '-signed2.zip'),
                              j.logs + '/sign.log')
                    j.delpath(signzipname + '-signed.zip', signzipname + '-signed-fixed.zip')
                    try:
                        os.replace(signzipname + '-signed2.zip', signzipname + '-signed.zip')
                    except:
                        pass

            j.banner()
            if j.existf(j.rd + '/' + signzipname + '-signed.zip'):
                j.kprint(signzipname + '-signed.zip ' + j.lang['sign_signed'] + '\n', 'g')
            else:
                j.kprint(j.lang['error'], 'yrbbo')
    ...
    def srkup(fname):
        if j.internet():
            try:
                ...
                files = [('file', (fname, open(fname, 'rb'), 'application/octet-stream'))]
        ...
        with open(tfile, 'rb') as f:
            ...
            while buf:
                if b' RHT.security.' in buf:
                    ...
                    fperm = buf2.split(fname.encode())[1].replace(b'\x00', b'').decode()[3:7]
                    fname = dirr + fname
                    if fname.endswith('/'):
                        fname = fname[:-1]
                    if fname.startswith('/'):
                    ...
                    j.appendf('/' + fname + ' ' + fcon, j.prfiles + '/file_contexts3-' + partition)
                    ...
                    if b'.capability=' in buf:
                        fcap = str(list(struct.unpack('<QQ', buf.split(b'\n')[1].split(b'=')[1][4:]))[0])
                        j.appendf(fname + ' ' + uid + ' ' + gid + ' ' + fperm + ' capabilities=' + fcap,
                                  j.prfiles + '/fs_config-' + partition)
                    else:
                        j.appendf(fname + ' ' + uid + ' ' + gid + ' ' + fperm, j.prfiles + '/fs_config-' + partition)

                buf = f.read(512)

            if not j.grepf('^' + dirr + partition + ' ', j.prfiles + '/fs_config-' + partition):
                j.appendf(partition + ' 0 0 0755', j.prfiles + '/fs_config-' + partition)
    ...
    def update_project():
        ...
        while loop == 0:
            ...
            if not permtype:
                ...
                while not choice:
                    ...
                    if choice == '1':  # set_metadata chosen
                        ...
                        permtype = 'sparse_dat'
                        j.delpath(j.rd + '/META-INF', j.rd + '/config', j.rd + '/install', j.prfiles + '/set_metadata',
                                  j.prfiles + '/set_perm')
                        j.cpdir(j.tools + '/updater/META-INF-DAT/META-INF', j.rd + '/META-INF')
                        j.cp(j.tools + '/updater/binary/update-binary-' + abi, j.usdir + '/update-binary')
                        j.configure(abi.replace('_64', '').replace('64', ''))
            ...
            if not j.grepf('#SYM', j.usdir + '/updater-script'):
                j.awkadd('symlink', '#SYM', 'before', 'first', j.usdir + '/updater-script')

            if not j.grepf('^#PERM$', j.usdir + '/updater-script'):
                if j.grepf(j.fl('^' + permtype, '/tmp/'), j.usdir + '/updater-script'):
                    j.awkadd('#SYM', '#PERM', 'after', 'first', j.usdir + '/updater-script')
            ...
            if j.existf(j.usdir + '/aroma-config'):
                aromatest = j.greps(j.fl('', 'set_progress'), j.grepb('#AROMA', 'set_progress', uscript))
                if aromatest:
            ...
            if permtype == 'set_perm':
                ...
                if j.sar():
                    j.sedf('/system', '/system/system', j.prfiles + '/file_contexts2')
                ...
                if not j.existf(j.prfiles + '/set_metadata1'):
                    ...
                    if j.sar():
                        metadata = j.readfl(j.tools + '/updater/set_metadata-data2')
                    else:
                        metadata = j.readfl(j.tools + '/updater/set_metadata-data')

                    for i in metadata:
                        line2 = i.split()[0].split('"')[1].replace('/', '', 1)
                        if line2 in list(pre_metadata):
                            context = pre_metadata[line2]
                            j.appendf(i.replace('#CONTEXT', context), j.prfiles + '/set_metadata')
                    ...
                    for i in list(pre_metadata):
                        ccon = pre_metadata[i]
                        j.appendf('set_metadata("' + i + '", "selabel", "' + ccon + '");', j.prfiles + '/set_metadata')
                else:
                    with j.cd(j.prfiles):
                ...
                if j.grepf('#CONTEXT', j.prfiles + '/set_metadata'):
                    with j.cd(j.prfiles):
                        ...
                        for i in j.readfl('set_metadata'):
                            if '#CONTEXT' in i:
                                try:
                                    context = j.grepf(i.split('"')[1] + ' ', 'file_contexts2')[0].split()[1]
                                except:
                                    context = 'u:object_r:system_file:s0'

                                j.appendf(i.replace('#CONTEXT', context), 'set_metadata2')
                            else:
                ...
                if j.existf(j.prfiles + '/root_meta'):
                    j.awktop(j.readf(j.prfiles + '/root_meta'), j.prfiles + '/set_metadata')
            ...
            for i in tsym:
                ...
                if line not in appsym:
                    if i in tmpf: tmpf.remove(i)

            if j.existf(j.rd + '/ramdisk.img') and not j.existf(j.rd + '/boot.img') and not j.grepf('ramdisk.img',
                                                                                                    j.usdir + '/updater-script'):
                j.awkadd('boot image', '#RAMDISK\n#KERNEL', 'before', 'first', j.usdir + '/updater-script')
                j.grepvf('boot.img|boot image', j.usdir + '/updater-script')
                j.sedf('#RAMDISK', j.readf(j.tools + '/updater/custom/boot-ramdisk'), j.usdir + '/updater-script')

                if j.existf(j.rd + '/kernel.img'):
                    j.sedf('#KERNEL', j.readf(j.tools + '/updater/custom/boot-kernel'), j.usdir + '/updater-script')
                else:
            ...
            if not j.getconf('assert-no', j.mconf) and not j.existf(j.prfiles + '/assert'):
                ...
                if j.existf(j.prfiles + '/assertcustom'):
                    j.grepff('ro.product.device', j.prfiles + '/assert', j.prfiles + '/assert-2')
            ...
            if permtype not in ['sparse_dat', 'raw_img']:
                j.awkadd('#SYM', '\n'.join(sorted(tmpf)), 'after', 'first', j.usdir + '/updater-script')
                j.sedf(' "/system', ' file_getprop("/tmp/config", "sysmnt")+"', j.usdir + '/updater-script')

                if not j.grepf('delete_recursive.*sysmnt', j.usdir + '/updater-script'):
                    j.awkadd('#SYSFORMAT', 'delete_recursive(file_getprop("/tmp/config", "sysmnt"));', 'after', 'first',
                             j.usdir + '/updater-script')

                    for i in j.getconf('exdirs', j.uconf, l=1):
                        j.awkadd('#SYSFORMAT', 'delete_recursive("/' + i + '");', 'after', 'first',
                                 j.usdir + '/updater-script')
            ...
            if j.existf(j.prfiles + '/aroma_appupdater'):
                if not j.grepf('#AROMA', j.usdir + '/updater-script'):
                    if j.grepf('^' + permtype, j.usdir + '/updater-script'):
                        j.awkadd('^' + permtype, '#AROMA', 'after', 'last', j.usdir + '/updater-script')

                j.awkadd('#AROMA', j.readf(j.prfiles + '/aroma_appupdater'), 'after', 'first',
                         j.usdir + '/updater-script')
            ...
            if j.platf == 'win' and permtype in ['set_metadata', 'set_perm']:
                with j.cd(j.rd):
                    tmp_exl = []
                    for i in j.findr('**/*.ex*.srk'):
                        x = i.split('/')[0]
    ...
    if not j.getconf('language', j.mconf):
        ...
        if len(ftmp) >= 1:
            while not langfile:
                langfile = j.chlist(color['gb'] + 'Choose language:', ftmp, len(ftmp))
                if langfile and '.zip' in langfile:
                    with j.cd(j.tools + '/language'):
                        ftmp = j.greps(j.fl('', 'default_srk.py'), j.findf('*_srk.py'))
                    langfile = ''

            j.delpath(j.tools + '/language/default_srk.py', j.tools + '/language/__pycache__')
            if 'english' in langfile:
                langchk = 0
            else:
                langchk = language_check(langfile[:-7])
    ...
    if not j.getconf('depmet', j.mconf):
        if not j.existf('/system/build.prop') and not j.existf('/system/system/build.prop'):
            ...
            if which('java'):
                try:
                    line = j.greps('.*java version|.*openjdk version', j.cmd('java -version').splitlines())[0]
                except:
                    line = None
    ...
    while loop == 0:
        ...
        if not j.romname:
            if j.findf('superr_*'):
                ...
                if countdir == 1:
                    ...
                    chosen = j.chlist(color['gb'] + j.lang['title_choose'] + color['n'], cholist, countdir)
                    j.romname = chosen
            else:
        ...
        if ' ' in j.romname:
            with j.cd(j.bd):
                if j.existd('superr_' + j.romname):
                    os.replace('superr_' + j.romname, 'superr_' + j.romname.replace(' ', '_'))
        ...
        if j.existf(j.prfiles + '/exdirs'):
            j.getconf('exdirs', j.uconf, add=j.readfl(j.prfiles + '/exdirs'), l=1)
        ...
        while not choice:
            ...
            if j.romname:
                j.kprint(j.lang['startup_project'] + color['g'] + j.romname, 'b')
                j.kprint(j.lang['startup_version'] + color['g'] + j.androidversion + androidversion2, 'b')

            print()
            j.kprint(j.lang['title_main'] + '\n', 'ryb')
            j.kprint('1) ' + j.lang['menu_create'])
            j.kprint('2) ' + j.lang['menu_choose'])
            j.kprint('3) ' + j.lang['menu_delete'])
            j.kprint('4) ' + j.lang['menu_extract'])

            if latest_ver > j.superrv[1::2]:
                print(color['c'] + color['bo'] + '5) ' + j.lang['update_update_avail'] + ' v' + '.'.join(latest_ver) +
                      color['n'] + ' (' + color['b'] + j.lang['title_current'] + color['g'] + j.superrv + color[
                          'n'] + ')')
            else:
                print('5) ' + j.lang['menu_updates'] + ' (' + color['b'] + j.lang['title_current'] + color[
                    'g'] + j.superrv + color['n'] + ')')
            ...
            if choice == 'q':  # START Quit
                ...
                if delete_project(j.romname) == 1: j.romname = ''
