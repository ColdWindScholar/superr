...
DESCRIPTOR = _descriptor.FileDescriptor(name='update_metadata.proto',
  package='chromeos_update_engine',
  syntax='proto2',
  serialized_pb=(_b('\n\x15update_metadata.proto\x12\x16chromeos_update_engine"1\n\x06Extent\x12\x13\n\x0bstart_block\x18\x01 \x01(\x04\x12\x12\n\nnum_blocks\x18\x02 \x01(\x04"z\n\nSignatures\x12@\n\nsignatures\x18\x01 \x03(\x0b2,.chromeos_update_engine.Signatures.Signature\x1a*\n\tSignature\x12\x0f\n\x07version\x18\x01 \x01(\r\x12\x0c\n\x04data\x18\x02 \x01(\x0c"+\n\rPartitionInfo\x12\x0c\n\x04size\x18\x01 \x01(\x04\x12\x0c\n\x04hash\x18\x02 \x01(\x0c"w\n\tImageInfo\x12\r\n\x05board\x18\x01 \x01(\t\x12\x0b\n\x03key\x18\x02 \x01(\t\x12\x0f\n\x07channel\x18\x03 \x01(\t\x12\x0f\n\x07version\x18\x04 \x01(\t\x12\x15\n\rbuild_channel\x18\x05 \x01(\t\x12\x15\n\rbuild_version\x18\x06 \x01(\t"Ó\x03\n\x10InstallOperation\x12;\n\x04type\x18\x01 \x02(\x0e2-.chromeos_update_engine.InstallOperation.Type\x12\x13\n\x0bdata_offset\x18\x02 \x01(\r\x12\x13\n\x0bdata_length\x18\x03 \x01(\r\x123\n\x0bsrc_extents\x18\x04 \x03(\x0b2\x1e.chromeos_update_engine.Extent\x12\x12\n\nsrc_length\x18\x05 \x01(\x04\x123\n\x0bdst_extents\x18\x06 \x03(\x0b2\x1e.chromeos_update_engine.Extent\x12\x12\n\ndst_length\x18\x07 \x01(\x04\x12\x18\n\x10data_sha256_hash\x18\x08 \x01(\x0c\x12\x17\n\x0fsrc_sha256_hash\x18\t \x01(\x0c"\x92\x01\n\x04Type\x12\x0b\n\x07REPLACE\x10\x00\x12\x0e\n\nREPLACE_BZ\x10\x01\x12\x08\n\x04MOVE\x10\x02\x12\n\n\x06BSDIFF\x10\x03\x12\x0f\n\x0bSOURCE_COPY\x10\x04\x12\x11\n\rSOURCE_BSDIFF\x10\x05\x12\x08\n\x04ZERO\x10\x06\x12\x0b\n\x07DISCARD\x10\x07\x12\x0e\n\nREPLACE_XZ\x10\x08\x12\x0c\n\x08PUFFDIFF\x10\t"¦\x03\n\x0fPartitionUpdate\x12\x16\n\x0epartition_name\x18\x01 \x02(\t\x12\x17\n\x0frun_postinstall\x18\x02 \x01(\x08\x12\x18\n\x10postinstall_path\x18\x03 \x01(\t\x12\x17\n\x0ffilesystem_type\x18\x04 \x01(\t\x12M\n\x17new_partition_signature\x18\x05 \x03(\x0b2,.chromeos_update_engine.Signatures.Signature\x12A\n\x12old_partition_info\x18\x06 \x01(\x0b2%.chromeos_update_engine.PartitionInfo\x12A\n\x12new_partition_info\x18\x07 \x01(\x0b2%.chromeos_update_engine.PartitionInfo\x12<\n\noperations\x18\x08 \x03(\x0b2(.chromeos_update_engine.InstallOperation\x12\x1c\n\x14postinstall_optional\x18\t \x01(\x08"Ä\x05\n\x14DeltaArchiveManifest\x12D\n\x12install_operations\x18\x01 \x03(\x0b2(.chromeos_update_engine.InstallOperation\x12K\n\x19kernel_install_operations\x18\x02 \x03(\x0b2(.chromeos_update_engine.InstallOperation\x12\x18\n\nblock_size\x18\x03 \x01(\r:\x044096\x12\x19\n\x11signatures_offset\x18\x04 \x01(\x04\x12\x17\n\x0fsignatures_size\x18\x05 \x01(\x04\x12>\n\x0fold_kernel_info\x18\x06 \x01(\x0b2%.chromeos_update_engine.PartitionInfo\x12>\n\x0fnew_kernel_info\x18\x07 \x01(\x0b2%.chromeos_update_engine.PartitionInfo\x12>\n\x0fold_rootfs_info\x18\x08 \x01(\x0b2%.chromeos_update_engine.PartitionInfo\x12>\n\x0fnew_rootfs_info\x18\t \x01(\x0b2%.chromeos_update_engine.PartitionInfo\x129\n\x0eold_image_info\x18\n \x01(\x0b2!.chromeos_update_engine.ImageInfo\x129\n\x0enew_image_info\x18\x0b \x01(\x0b2!.chromeos_update_engine.ImageInfo\x12\x18\n\rminor_version\x18\x0c \x01(\r:\x010\x12;\n\npartitions\x18\r \x03(\x0b2\'.chromeos_update_engine.PartitionUpdateB\x02H\x03')))
_INSTALLOPERATION_TYPE = _descriptor.EnumDescriptor(name='Type',
  full_name='chromeos_update_engine.InstallOperation.Type',
  filename=None,
  file=DESCRIPTOR,
  values=[
 _descriptor.EnumValueDescriptor(name='REPLACE',
   index=0,
   number=0,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='REPLACE_BZ',
   index=1,
   number=1,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='MOVE',
   index=2,
   number=2,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='BSDIFF',
   index=3,
   number=3,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='SOURCE_COPY',
   index=4,
   number=4,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='SOURCE_BSDIFF',
   index=5,
   number=5,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='ZERO',
   ...
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='DISCARD',
   index=7,
   number=7,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='REPLACE_XZ',
   index=8,
   number=8,
   options=None,
   type=None),
 _descriptor.EnumValueDescriptor(name='PUFFDIFF',
   index=9,
   number=9,
   options=None,
   type=None)],
...
_EXTENT = _descriptor.Descriptor(name='Extent',
 ...
 _descriptor.FieldDescriptor(name='start_block',
   ...
   options=None),
 _descriptor.FieldDescriptor(name='num_blocks',
  ...
  serialized_start=49,
  serialized_end=98)
_SIGNATURES_SIGNATURE = _descriptor.Descriptor(name='Signature',
 ...
 _descriptor.FieldDescriptor(name='data',
  ...
  serialized_end=222)
_SIGNATURES = _descriptor.Descriptor(name='Signatures',
 ...
 _SIGNATURES_SIGNATURE],
  ...
  serialized_end=222)
_PARTITIONINFO = _descriptor.Descriptor(name='PartitionInfo',
 ...
 _descriptor.FieldDescriptor(name='hash',
  ...
  serialized_end=267)
_IMAGEINFO = _descriptor.Descriptor(name='ImageInfo',
  full_name='chromeos_update_engine.ImageInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='board',
 ...
 _descriptor.FieldDescriptor(name='version',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='build_channel',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='build_version',
  ...
  serialized_end=388)
_INSTALLOPERATION = _descriptor.Descriptor(name='InstallOperation',
 ...
 _descriptor.FieldDescriptor(name='type',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='data_offset',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='data_length',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='src_extents',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='src_length',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='dst_extents',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='dst_length',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='data_sha256_hash',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='src_sha256_hash',
 ...
 _INSTALLOPERATION_TYPE],
  ...
  serialized_end=858)
_PARTITIONUPDATE = _descriptor.Descriptor(name='PartitionUpdate',
  full_name='chromeos_update_engine.PartitionUpdate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='partition_name',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='run_postinstall',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='postinstall_path',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='filesystem_type',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='new_partition_signature',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='old_partition_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='new_partition_info',
 ...
 _descriptor.FieldDescriptor(name='operations',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='postinstall_optional',
  ...
  serialized_end=1283)
_DELTAARCHIVEMANIFEST = _descriptor.Descriptor(name='DeltaArchiveManifest',
  full_name='chromeos_update_engine.DeltaArchiveManifest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 _descriptor.FieldDescriptor(name='install_operations',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='kernel_install_operations',
 ...
 _descriptor.FieldDescriptor(name='block_size',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='signatures_offset',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='signatures_size',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='old_kernel_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='new_kernel_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='old_rootfs_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='new_rootfs_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='old_image_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='new_image_info',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='minor_version',
   ...
   extension_scope=None,
   options=None),
 _descriptor.FieldDescriptor(name='partitions',
...
Extent = _reflection.GeneratedProtocolMessageType('Extent', (_message.Message,), dict(DESCRIPTOR=_EXTENT,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(Extent)
Signatures = _reflection.GeneratedProtocolMessageType('Signatures', (_message.Message,), dict(Signature=(_reflection.GeneratedProtocolMessageType('Signature', (_message.Message,), dict(DESCRIPTOR=_SIGNATURES_SIGNATURE,
  __module__='update_metadata_pb2'))),
  DESCRIPTOR=_SIGNATURES,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(Signatures)
_sym_db.RegisterMessage(Signatures.Signature)
PartitionInfo = _reflection.GeneratedProtocolMessageType('PartitionInfo', (_message.Message,), dict(DESCRIPTOR=_PARTITIONINFO,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(PartitionInfo)
ImageInfo = _reflection.GeneratedProtocolMessageType('ImageInfo', (_message.Message,), dict(DESCRIPTOR=_IMAGEINFO,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(ImageInfo)
InstallOperation = _reflection.GeneratedProtocolMessageType('InstallOperation', (_message.Message,), dict(DESCRIPTOR=_INSTALLOPERATION,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(InstallOperation)
PartitionUpdate = _reflection.GeneratedProtocolMessageType('PartitionUpdate', (_message.Message,), dict(DESCRIPTOR=_PARTITIONUPDATE,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(PartitionUpdate)
DeltaArchiveManifest = _reflection.GeneratedProtocolMessageType('DeltaArchiveManifest', (_message.Message,), dict(DESCRIPTOR=_DELTAARCHIVEMANIFEST,
  __module__='update_metadata_pb2'))
_sym_db.RegisterMessage(DeltaArchiveManifest)
DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('H\x03'))
